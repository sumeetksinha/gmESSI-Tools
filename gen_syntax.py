...
os.system("rm -r gmESSI.sublime-completions")

# # updating snippets and keywords
os.system("svn export --force https://github.com/BorisJeremic/Real-ESSI/branches/sumeet/DSL/GmessiDocs/GMESSI_PLUGIN/gmESSI.sublime-completions") 
